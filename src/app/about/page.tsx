  ...
  return (
    <Container className="py-16">
      ...
      <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
        ...
        short-form video PSAs, and every PSA is backed by a rigorous, sourced,
        data-driven case published here. The mission is to raise visibility
        and urgency around environmental regulation and action, and to help
        drive the transition to a sustainable economy and healthier planet.
      </p>
      ...
      <section className="mt-16">
        ...
        <p className="mt-4 max-w-2xl text-muted-foreground">
          ...
          background at Workday and Oracle — transitioning into environmental
          evangelism. The persona, &ldquo;OB1,&rdquo; is a Jedi-inspired
          evangelist: playful in tone, serious in substance. The bet is that
          analytics discipline — clear evidence, clear stakes, clear stories —
          can close the gap between knowing and acting the same way it has
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {contentModel.map((item, i) => (
            <div key={item.title} className="rounded-2xl border border-border bg-card p-5">
              ...
              <p className="mt-2 font-heading font-semibold">{item.title}</p>
